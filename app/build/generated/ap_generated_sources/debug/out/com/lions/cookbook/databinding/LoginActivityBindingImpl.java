...
public class LoginActivityBindingImpl extends LoginActivityBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.user_id, 1);
        sViewsWithIds.put(R.id.user_password, 2);
        sViewsWithIds.put(R.id.login_btn, 3);
        sViewsWithIds.put(R.id.new_acct, 4);
        sViewsWithIds.put(R.id.signUpLink, 5);
    }
    // views
    @NonNull
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.presenter == variableId) {
            setPresenter((com.lions.cookbook.LoginPresent) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setPresenter(@Nullable com.lions.cookbook.LoginPresent Presenter) {
